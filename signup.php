...
<html>
<head>
    <title>Bootcamp Registration - Summer Tech Series</title>
...
<body>
    ...
    <fieldset>
        <div id="legend" class="">
            <legend class="">Dev Bootcamp - Registration</legend>
        </div>
        ...
        <div class="control-group">
            <label class="control-label">The reason I want to learn to code is: </label>
            <div class="controls">
                <div class="textarea">
                    <textarea name="reason" type="" class="" style="margin-left: 0px; margin-right: 0px; width: 262px;"> </textarea>
                </div>
            </div>
        </div>
