...
<html>
<head>
    <title>Contact Us - Summer Tech Series</title>
...
<body>
    ...
    <fieldset>
        <div id="legend" class="">
            <legend class="">Drop Us A Line</legend>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <label class="checkbox">
                    <input type="checkbox" name="interest[]" value="Accelerator">
                    the Accelerator
                </label>
                <label class="checkbox">
                    <input type="checkbox" name="interest[]" value="Bootcamp">
                    the Bootcamp
                </label>
                <label class="checkbox">
                    <input type="checkbox" name="interest[]" value="Hackathon">
                    the Hackathon
                </label>
            </div>
        </div>
        ...
        <div class="control-group">
            <label class="control-label">My question is: </label>
            <div class="controls">
                <div class="textarea">
                    <textarea name="question" type="" class="" style="margin-left: 0px; margin-right: 0px; width: 262px;"> </textarea>
                </div>
            </div>
        </div>
